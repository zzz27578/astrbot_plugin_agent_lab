...
ACTION_EXECUTION_MODES = {
    ...
    "api_scope": "deterministic",
    "dispatch_tasks": "deterministic",
    "collect_report": "deterministic",
    "agent_message": "deterministic",
    "agent_debate": "hybrid",
    "summarize_decision": "deterministic",
    "prompt_inject": "deterministic",
    "note": "deterministic",
    "delay": "deterministic",
    "retry": "deterministic",
...
ACTION_PORT_SCHEMAS: dict[str, dict[str, list[str]]] = {
    ...
    "agent_role": {"inputs": ["input"], "outputs": ["success", "failed", "error"]},
    "api_scope": {"inputs": ["input"], "outputs": ["success", "failed", "error"]},
    "prompt_inject": {"inputs": ["input"], "outputs": ["success", "failed", "error"]},
