...
- 工作流节点、节点素材、拖拽位置和连线在独立“工作流画布”页编辑；“任务模式设置”页只保留触发、入口/出口话术、隔离、记忆、审批、心跳和提示词。画布支持左侧导航收缩/展开、右侧素材抽屉、右侧节点编辑抽屉、圆点拉线、彩色连线、右键复制/删除、连线删除、缩放、专注模式、自动布局、检查工作流和预跑诊断，原始 JSON 只作为高级导入/导出兜底。
